...
HTTP::OAI::DataProvider::Mapping::MPX - MPX-specific extensions
...
=head2 my $header=$self->_extractHeader ($node);
...
=head2 my $metadata=$self->_mk_md ($doc, $currentId);
...
=head2 my ($node, $header) = $self->_setRules ($node, $header);
