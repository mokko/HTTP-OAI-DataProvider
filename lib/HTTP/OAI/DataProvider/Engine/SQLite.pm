...
HTTP::OAI::DataProvider::Engine::SQLite - A simple and fairly generic SQLite engine for HTTP::OAI::DataProvider
...
=head2 my ( $total, $maxChunkNo ) =$self->_mk_numbers($params);
...
=head2 my $datestamp=$engine->_datestampDB($record); 
