...
{
  $HTTP::OAI::DataProvider::VERSION = '0.007';
}
...
=head2 return $provider->errorOAI;
...
=head2 my $xml=$self->_output($response);
...
=head2 $self->_validateRequest(%params) or return $self->error;
